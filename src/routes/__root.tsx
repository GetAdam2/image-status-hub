...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ministry of Revenue — Letter Case Tracker" },
      { name: "description", content: "Internal letter case tracker for the Ministry of Revenue." },
      { name: "author", content: "Ministry of Revenue" },
      { property: "og:title", content: "Ministry of Revenue — Letter Case Tracker" },
      { property: "og:description", content: "Internal letter case tracker for the Ministry of Revenue." },
